CREATE SCHEMA IF NOT EXSITS `eventDBv2`;

USE eventDBv2;

DROP TABLE I EXISTS `availability`;
DROP TABLE I EXISTS `records`;
DROP TABLE I EXISTS `emps`;
DROP TABLE I EXISTS `deps`;
DROP TABLE I EXISTS `rooms`;
